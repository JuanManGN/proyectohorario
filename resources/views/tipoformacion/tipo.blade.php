...
<head>
    ...
    <title class="flex justify-end" style="font-size: 30px; font-weight: bold; margin:15px 500px;">TIPOS DE FOORMACION</title>
</head>
<body>
<div class="px-50 py-100 rounded-lg mb-8 relative">
    <div class="flex justify-end">
        <button type="button" class="btn btn-outline-success"  style="background:#469C00; margin:15px;">
            <a href="{{route('create_tip')}}" class="text-indigo-600">AÑADIR TIPOS DE FORMACION</a>
        </button>
    </div>
