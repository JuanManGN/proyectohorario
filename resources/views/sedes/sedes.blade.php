...
<head>
    ...
    <title class="flex justify-end" style="font-size: 30px; font-weight: bold; margin:15px 500px;">SEDES</title>
</head>
<body>
<div class="px-50 py-100 rounded-lg mb-8 relative">
    <div class="flex justify-end">
        <button type="button" class="btn btn-outline-success"  style="background:#469C00; margin:15px;">
            <a href="{{route('create')}}" class="text-indigo-600">AÑADIR SEDES</a>
        </button>
    </div>
    ...
    <div class="cards">
        <div class="card" style="width: 20rem;">
            ...
            <div class="card-body">
                ...
                <h8 class="card-text">{{$a->direccion}}</h8>
